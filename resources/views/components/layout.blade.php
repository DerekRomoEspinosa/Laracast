...
<div class="min-h-full">
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="shrink-0">
              <img class="size-8" src="https://ai-images.s3.eu-central-1.wasabisys.com/29645241/573777/4592bc91-01e5-4b27-8ddf-39f28c934-04.png" alt="Your Company">
            </div>
              ...
              <div class="relative ml-3">
                <div>
                  <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <img class="size-8 rounded-full" src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcT3Di7FiMG7cw9wztr9WqTp1-13t8OF2d2UCiq2RPawrJAIu45iyc9GituxVCbhOEJa0jFSEIDDktoWslx3MgVhwg" alt="">
                  </button>
                </div>
      ...
      <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
          <div class="flex items-center px-5">
            <div class="shrink-0">
              <img class="size-10 rounded-full" src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcT3Di7FiMG7cw9wztr9WqTp1-13t8OF2d2UCiq2RPawrJAIu45iyc9GituxVCbhOEJa0jFSEIDDktoWslx3MgVhwg" alt="">
            </div>
            <div class="ml-3">
    ...
    <header class="bg-white shadow-sm">
        ...
        <a href="/products/create" class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium  bg-white border  leading-5 rounded-md    transition ease-in-out duration-150 dark:bg-gray-100  dark:text-black dark:active:bg-gray-100 dark:active:text-gray-200">Agregar Producto</a>
    </div>
